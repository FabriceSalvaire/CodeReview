...
from PyQGit.Tools.Singleton import singleton
...
class EmailExceptionHook(ExceptionHook):
    ...
    def notify(self, exception_type, exception_value, exception_traceback):
        ...
        template_message = '''
Object: An exception occurred in PyQGit software on %(date)s UTC
...
'''
        ...
        email = Email(subject='An exception occurred in PyQGit software',
