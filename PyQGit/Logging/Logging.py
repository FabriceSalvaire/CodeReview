...
from PyQGit.Logging.ExceptionHook import DispatcherExceptionHook, StderrExceptionHook, EmailExceptionHook
from PyQGit.Tools.Singleton import singleton
import PyQGit.Config.ConfigInstall as ConfigInstall
