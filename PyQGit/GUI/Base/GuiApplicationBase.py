...
from PyQGit.GUI.Forms.CriticalErrorForm import CriticalErrorForm
from PyQGit.GUI.Forms.EmailBugForm import EmailBugForm
import PyQGit.Config.Config as Config
import PyQGit.Config.Messages as Messages
import PyQGit.Version as Version

# Load RC
#import PyQGit.gui.ui.pyqgit_rc
...
class GuiApplicationBase(ApplicationBase, QtWidgets.QApplication):
    ...
    def _display_splash_screen(self):
        ...
        self._splash.show()
        self._splash.showMessage('<h2>PyQGit %(version)s</h2>' % {'version':str(Version.pyqgit)})
        self.processEvents()
    ...
    def _init_actions(self):
        ...
        self.about_action = \
            QtWidgets.QAction('About PyQGit',
                          self,
    ...
    def post_init(self):
        ...
        self.show_message('Welcome to PyQGit')
    ...
    def critical_error(self, title='PyQGit Critical Error', message=''):
    ...
    def about(self):
        ...
        QtWidgets.QMessageBox.about(self.main_window, 'About PyQGit', message)
