...
from PyQGit.Logging.Email import Email
from PyQGit.Tools.Platform import Platform
import PyQGit.Config.Config as Config
import PyQGit.Version as Version

####################################################################################################

from PyQGit.GUI.ui.email_bug_form_ui import Ui_email_bug_form
...
"""
        ...
        email = Email(from_address=from_address,
                      subject='PyQGit Bug: ' + str(form.subject_line_edit.text()),
